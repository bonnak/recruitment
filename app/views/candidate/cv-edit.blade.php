					...
					<div>
						...
						<div class="items">						
							<div class="content-show">
								<h4 id="span-job-title" class="job-title" ng-bind="experience.job_title"></h4>
								<div>
							...
							<div class="form-edit">
								{{\Form::open(['route' => ['candidate.cv.edit.experience.put', $candidate->cv->id, $work_experience->id],  'method' => 'put', 'class' => 'form-horizontal'])}}
									<div class="form-group">
									    ...
									    <div class="col-sm-8">
									      <input type="text" class="form-control" id="input-job-title" ng-model="experience.job_title" ng-init="experience.job_title='{{$work_experience->job_title}}'">
									    </div>
									</div>
									<div class="form-group">
